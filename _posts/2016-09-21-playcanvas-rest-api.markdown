...
You can read more details about the API in the [documentation](http://developer.playcanvas.com/en/user-manual/api/).

We'd love to hear your thoughts on how you are using the API and what you'd like to see in the future. Let us know on our [forum](http://forum.playcanvas.com/t/playcanvas-rest-api/2498).
