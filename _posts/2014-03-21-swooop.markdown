...
For PlayCanvas developers, there's even better news. The [SWOOOP project](http://playcanvas.com/playcanvas/swooop) is open for you to view and the code is available on [Bitbucket](http://bitbucket.com/playcanvas/swooop). Browse the pack and source code for yourselves and learn about how the PlayCanvas team make games using the engine.
